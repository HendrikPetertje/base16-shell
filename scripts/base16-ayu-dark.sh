...
# AYU dark scheme by @hendrikpetertje and
...
color05="ff/ee/99" # Base 0E - Magenta
color06="95/e6/cb" # Base 0C - Cyan
color07="ff/ff/ff" # Base 05 - White
color08="3e/4b/59" # Base 03 - Bright Black
color09="ff/33/33" # Base 08 - Bright Red
color10="b8/cc/52" # Base 0B - Bright Green
color11="f2/97/18" # Base 0A - Bright Yellow
color12="36/a3/d9" # Base 0D - Bright Blue
color13="ff/ee/99" # Base 0E - Bright Magenta
color14="95/e6/cb" # Base 0C - Bright Cyan
color15="5c/67/73" # Base 07 - Bright White
color16="ff/b4/54" # Base 09
color17="e7/c5/47" # Base 0F
color18="14/19/1f" # Base 01
color19="1f/2c/39" # Base 02
